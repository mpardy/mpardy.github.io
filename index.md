...
As a researcher at **Imago**, I apply advanced measurement techniques by leveraging **machine learning and causal inference** on **high-resolution, high-frequency digital data**—such as satellite imagery and mobile phone data. By mapping Climate Local Vulnerability and Exposure alongside Land Use (Green and Built Environments), these cutting-edge tools allow us to precisely assess the economic, social, and distributional consequences of environmental hazards at a highly granular, local scale. At **LSE**, I serve as the co-director of the **[Economics of Environmental Inequality](https://www.lse.ac.uk/International-Inequalities/Research/Economics-of-Environmental-Inequality)** research programme and as a researcher within STICERD’s **[Cohesive Capitalism](https://sticerd.lse.ac.uk/cohesive-capitalism)** programme.

I hold a PhD in Economic Geography from LSE, where my thesis, *"Essays on Regional Inequalities, Innovation and Global Connectivity"*, was awarded the Charles Tiebout Prize for best PhD student paper by the Western Regional Science Association. During my PhD, I also served as a Marie Skłodowska-Curie Fellow focusing on Policies for Smart Specialisation. I have worked as a Research Associate at the University of Cambridge, a consultant at the Asian Development Bank, and a coordinator of the Regional Academy on the United Nations. I hold a Master’s in Economics (with distinction) from the Vienna University of Economics and Business and have been a visiting scholar at Sciences Po and Utrecht University.
...
::: {.grid .pub-grid}
::: {.g-col-12 .g-col-md-3}
![](assets/images/pub_placeholder.png){class="pub-img"}
:::
::: {.g-col-12 .g-col-md-9}
**[Multinationals and Innovation Concentration](https://doi.org/10.1016/j.respol.2025.105235)**  
*Published in Research Policy, 54(6), 105235.*  

<details><summary class="summary-btn"><i class="fas fa-chevron-right" style="font-size: 0.8em; margin-right: 5px;"></i> Abstract</summary>
...
:::
::: {.g-col-12 .g-col-md-9}
**[Trade Ties and Economic Divides: Trade and Income Inequality in the Regions of Europe](https://doi.org/10.1111/grow.1270036)**  
...
:::
::: {.g-col-12 .g-col-md-9}
**[The Political Impact of Inflation: A Survey Experiment](https://eprints.lse.ac.uk/123926/1/WP_140.pdf)**  
with Neil Lee and Andrew McNeil  
...
:::
::: {.g-col-12 .g-col-md-9}
**[Brexit and Digital Technology Adoption of SMEs in the UK](https://www.enterpriseresearch.ac.uk/wp-content/uploads/2023/07/ERC-ResPap106-Brexit-and-Digital-Technology-Adoption-of-UK-SMEs.pdf)**  
with David Ampudia  
...
:::
::: {.g-col-12 .g-col-md-9}
**[Income, sovereignty, and cohesion: the political economy of Europe’s first mover innovation deficit](https://researchonline.lse.ac.uk/id/eprint/137116/)**  
...
This hands-on workshop introduces participants to smart data products derived from satellite imagery and demonstrates their application to address pressing social and environmental challenges. Using data products from Imago, attendees engage in reproducible geospatial workflows to merge satellite-derived indicators with socioeconomic metrics, generating policy-relevant insights. The session emphasizes the role of GIS in tackling spatial inequalities and equips participants with transferable analytical skills.
:::
:::
...
FloodTraces addresses the critical gap in internal displacement data following climate-induced natural hazards by developing a replicable data pipeline that integrates digital trace data with traditional surveys. This three-day event combines a high-level policy dialogue with representatives from FCDO, NGOs, and partner organizations, followed by a two-day hackathon. The workshop focuses on presenting the Colombia and Indonesia Digital Traces Situation Reports and gathering structured feedback on their adoption potential.
:::
:::
...
:::
::: {.g-col-12 .g-col-md-9}
*Can We Tackle Climate Change Without Deepening Inequality? — 2026*
